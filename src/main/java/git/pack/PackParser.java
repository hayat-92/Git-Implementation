...
public class PackParser {
    ...
    public List<DeltaInstruction> parseDeltaInstructions(ByteBuffer buffer) {
        ...
        while (buffer.hasRemaining()) {
            ...
            if (command == 0) {
                ...
                final var offset = parseVariableLengthInteger(
                        buffer, hasOffset1, hasOffset2, hasOffset3, hasOffset4);
                var size =
                        parseVariableLengthInteger(buffer, hasSize1, hasSize2, hasSize3);
                if (size == 0) {
                    size = 0x10000;
                }
    ...
    public static int parseVariableLengthInteger(ByteBuffer buffer,
